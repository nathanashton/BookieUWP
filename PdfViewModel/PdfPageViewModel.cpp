...
namespace PdfViewModel
{
	...
	unsigned int PdfPageViewModel::PageNumber::get()
	{
		return pageIndex + 1;
	}

	bool PdfPageViewModel::BookMark::get()
	{
		return bookmark;
	}

	void PdfPageViewModel::BookMark::set(_In_ bool value)
	{
		bookmark = value;
		RaisePropertyChanged("BookMark");
